...
//		SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
		...
		vacante1.setId(1);
		vacante1.setNombre("Ingeniero Civileee"); // Titulo de la vacante
		vacante1.setDescripcion("Solicitamos Ing. Civil para diseñar puente peatonal.");

		// String date="15/05/2020";
		// LocalDate localDate = LocalDate.parse(date, formatter);

		vacante1.setFecha(LocalDate.parse("15-05-2020", formatter));
		vacante1.setSalario(14000.0);
		vacante1.setDestacado(1);
//			vacante1.setImagen("empresa1.png");
		vacante1.setDetalles("gaaaaaa");
		...
		vacante2.setFecha(LocalDate.parse("20-05-2020", formatter));
...
//			
		...
		vacante3.setFecha(LocalDate.parse("10-02-2019", formatter));
		...
		vacante4.setFecha(LocalDate.parse("11-02-2019", formatter));
